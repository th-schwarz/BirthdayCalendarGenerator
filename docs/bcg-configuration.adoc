...
- `dav.delay-in-minutes`: This property determines the delay interval (in minutes) between retries in the case of network problems.
- `dav.retry-delay-in-minutes`: The maximum number of retries due to network errors.
